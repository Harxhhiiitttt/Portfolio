...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!categoryButtons.length || !projectList || !projectDetails || !projectTitle || !projectDescription || !projectHighlights || !projectLink) {
    ...
    if (categoryButtons[0]) {
        console.log('Triggering first category');
        categoryButtons[0].click();
    } else {
        console.error('No category buttons found to initialize');
    }
});
